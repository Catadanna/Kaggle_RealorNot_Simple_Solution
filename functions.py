...
# Description: Pre-process training and test set inputing the training and test set as well as various parameters
# Output: X, Y and X_testset, ready for training and prediction
def parse_train(df_train, df_train_all, df_test, algo_type, max_words, add_keyword, parse_ce):
    n_components = 0
    limit = 10000
...
def print_into_file(y_pred, df_test, algo_name):
    l = []
